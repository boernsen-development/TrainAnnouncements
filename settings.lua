data:extend({
  ...
  },
  {
    ...
    allowed_values = {"jingle_regio", "jingle_changing", "jingle_random", "none"},
    order = "f"
  },
  {
    type = "string-setting",
